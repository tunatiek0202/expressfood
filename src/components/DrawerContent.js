            ...
            <DrawerContentScrollView {...props}>
                ...
                <View style={{flexDirection:'row',alignItems:'center',paddingLeft:20,paddingVertical:10}}>
                    <Avatar
                        ...
                        size={75}
                        source = {{uri:"https://variety.com/wp-content/uploads/2021/04/Avatar.jpg"}}
                    />

                    <View style ={{marginLeft:10}}>
                        <Text style ={{fontWeight:'bold',color:colors.cardbackground,fontSize:18 }}>Tuan Kiet</Text>
                        <Text style ={{color:colors.cardbackground,fontSize:14}}>ttk251200225@gmail.com</Text>
                    </View>
