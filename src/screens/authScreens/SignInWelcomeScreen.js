    ...
    <ScrollView contentContainerStyle = {{flexGrow: 1,justifyContent: 'space-between'}} >
        ...
        <View style ={{ }}>
            ...
            <View style={styles.slide1}>
                ...
                <Image
                        source={{uri:"https://eventusproduction.com/wp-content/uploads/2017/02/fresh-box.jpg"}}
                        style ={{height:"100%", width:"100%"}}
                />
                </View>
                <View style={styles.slide3}>
                <Image
                        source={{uri:"https://www.foodstylistvn.com/wp-content/uploads/2014/04/bo-nuong-vietnam-food-stylist.jpg"}}
                        style ={{height:"100%", width:"100%"}}
                />
                </View>
